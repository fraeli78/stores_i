var map, featureList, boroughSearch = [], theaterSearch = [], franchiseSearch = [];
...
var franchiseStores = L.geoJson(null, {
  ...
  onEachFeature: function (feature, layer) {
    if (feature.properties) {
      ...
      + feature.properties.Business_name + "</td></tr>" 
//      + "<tr><th>Phone</th><td>" 
//      + feature.properties.TEL + "</td></tr>" 
//      + "<tr><th>Address</th><td>" 
//      + feature.properties.ADDRESS1 + "</td></tr>" 
...
//      + feature.properties.URL + "</a></td></tr>" 
      ...
      layer.on({
        click: function (e) {
          $("#feature-title").html(feature.properties.Business_name);
          $("#feature-info").html(content);
          $("#featureModal").modal("show");
          highlight.clearLayers().addLayer(L.circleMarker([feature.geometry.coordinates[1], feature.geometry.coordinates[0]], highlightStyle));
        }
...
var groupedOverlays = {
  "Points of Interest": {
    ...
    "<img src='assets/img/theater.png' width='24' height='28'>&nbsp;FranchiseStore": franchiseStoresLayer,  
  },
  "Reference": {
    "Boroughs": boroughs,
...
$(document).one("ajaxStop", function () {
...

 {
    ...
    templates: {
      header: "<h4 class='typeahead-header'><img src='assets/img/theater.png' width='24' height='28'>&nbsp;FranchiseStores</h4>",
      suggestion: Handlebars.compile(["{{name}}<br>&nbsp;<small>{{address}}</small>"].join(""))
    }
  },
{
    ...
    if (datum.source === "FranchiseStores") {
      if (!map.hasLayer(franchiseStoresLayer)) {
        map.addLayer(franchiseStoresLayer);
      }
      map.setView([datum.lat, datum.lng], 17);
